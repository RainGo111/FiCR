    ...
    return (
        <div className="min-h-screen bg-white print:bg-white">
            ...
            <header className="border-b border-slate-200 sticky top-0 z-30 bg-white/95 backdrop-blur-sm">
                <div className="max-w-6xl mx-auto px-6 py-5 flex justify-between items-center">
                    <div className="flex items-center gap-4">
                        <div className="bg-primary-600 p-2.5 rounded-lg text-white shadow-sm">
                            <Rocket size={22} />
                        </div>
                        <div>
            ...
            <main className="max-w-6xl mx-auto px-6 py-10 space-y-12 font-sans">
                ...
                <section>
                    <div className="border-l-4 border-primary-600 pl-4 mb-6">
                            ...
                            return (
                                ...
                                >
                                    <div className="flex items-start gap-5">
                                        {/* Icon */}
                                        <div className="bg-slate-50 border border-slate-200 p-3 rounded-lg text-primary-600 shrink-0">
                                            {item.icon}
                                        </div>
                ...
                {/* ========== Section 3: Vision / 愿景 ========== */}
                <section>
                    <Card className="p-8 bg-slate-50 border border-slate-200 shadow-sm text-center">
