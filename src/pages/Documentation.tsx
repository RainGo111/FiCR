          ...
          <section id="introduction" className="mb-12 scroll-mt-20">
            ...
            <Card>
              <div className="space-y-5">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-neutral-900 mb-2">Namespace</h3>
                  <p className="text-neutral-700 leading-relaxed font-mono text-sm bg-neutral-50 px-3 py-2 rounded-lg border border-neutral-200">
                    {siteConfig.ontology.prefix}: &lt;{siteConfig.ontology.namespace}&gt;
                  </p>
                </div>
                <div>
                  <h3 className="text-lg font-semibold text-neutral-900 mb-2">Dependencies</h3>
                  <p className="text-neutral-700 leading-relaxed mb-3">
                    FiCR extends the <a href="https://w3id.org/bot#" target="_blank" rel="noopener noreferrer" className="text-primary-600 hover:underline font-medium">Building Topology Ontology (BOT)</a> for
                    spatial structure (Site, Building, Storey, Space) and element–space relationships
                    (<span className="font-mono text-sm">bot:adjacentElement</span>, <span className="font-mono text-sm">bot:hasSpace</span>).
                    All fire-safety-specific concepts — elements, roles, compliance, risk — are defined in the FiCR namespace.
                  </p>
                  <div className="overflow-x-auto">
                    <table className="text-sm w-full">
                      <thead>
                        <tr className="border-b-2 border-neutral-200">
                          <th className="text-left py-2 pr-4 font-semibold text-neutral-700">Prefix</th>
                          <th className="text-left py-2 pr-4 font-semibold text-neutral-700">Namespace</th>
                          <th className="text-left py-2 font-semibold text-neutral-700">Role</th>
                        </tr>
                      </thead>
                      <tbody className="text-neutral-600">
                        <tr className="border-b border-neutral-100">
                          <td className="py-2 pr-4 font-mono font-medium">ficr:</td>
                          <td className="py-2 pr-4 font-mono text-xs">{siteConfig.ontology.namespace}</td>
                          <td className="py-2">FiCR domain concepts</td>
                        </tr>
                        <tr className="border-b border-neutral-100">
                          <td className="py-2 pr-4 font-mono font-medium">bot:</td>
                          <td className="py-2 pr-4 font-mono text-xs">https://w3id.org/bot#</td>
                          <td className="py-2">Building spatial topology (imported)</td>
                        </tr>
                        <tr className="border-b border-neutral-100">
                          <td className="py-2 pr-4 font-mono font-medium">owl:</td>
                          <td className="py-2 pr-4 font-mono text-xs">http://www.w3.org/2002/07/owl#</td>
                          <td className="py-2">OWL 2 constructs (equivalentClass, restrictions)</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
