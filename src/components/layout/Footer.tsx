    ...
    <footer className="glass border-t border-white/20 mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-sm font-sans font-semibold text-primary-900 uppercase tracking-wider mb-4">
              About FiCR
            </h3>
            <p className="text-sm font-sans text-primary-700 leading-relaxed">
            ...
            <ul className="space-y-2">
              <li>
                <a
                  ...
                  className="text-sm font-sans text-primary-700 hover:text-accent-600 transition-smooth flex items-center gap-1"
                >
                  Ontology URI
        ...
        <div className="mt-8 pt-8 border-t border-white/20 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-sm font-sans text-primary-600">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="text-primary-600 hover:text-primary-900 transition-smooth"
            aria-label="GitHub"
          >
